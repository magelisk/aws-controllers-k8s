...
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=aliases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=aliases/status,verbs=get;update;patch
