...
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=eventsourcemappings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=lambda.services.k8s.aws,resources=eventsourcemappings/status,verbs=get;update;patch
