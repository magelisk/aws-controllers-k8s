...
func (rm *resourceManager) sdkFind(
	...
	rm.metrics.RecordAPICall("READ_ONE", "GetEventSourceMapping", respErr)
	if respErr != nil {
...
func (rm *resourceManager) sdkCreate(
	...
	rm.metrics.RecordAPICall("CREATE", "CreateEventSourceMapping", respErr)
	if respErr != nil {
		return nil, respErr
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkUpdate(
	...
	rm.metrics.RecordAPICall("UPDATE", "UpdateEventSourceMapping", respErr)
	if respErr != nil {
		return nil, respErr
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkDelete(
	...
	rm.metrics.RecordAPICall("DELETE", "DeleteEventSourceMapping", respErr)
	return respErr
}
